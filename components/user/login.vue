      ...
      <div class="modal-card" style="width: auto">
        <transition name="fade" mode="out-in">
          ...
          >
            ...
            <p class="resend-code-text" @click="checkResendTime" :class="{'p-text': resendTime == 0}">
              ارسال مجدد کد<span v-if="resendTime != 0"> تا {{ resendTime }} ثانیه دیگر</span>
            </p>
          </section>
          ...
          >
            ...
            <p class="state-explaination">
              جهت تکمیل ثبت نام، نام و نام‌خانوادگی خود را وارد
              کنید
            </p>
